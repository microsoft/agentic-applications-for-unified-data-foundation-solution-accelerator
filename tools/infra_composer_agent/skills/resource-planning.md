...
6. Beyond networking, app topology, MCP, and existing-resource reuse, also consider asking (only when genuinely undecided from the request and relevant to the modules involved):
