...
module searchServiceEnableIdentity 'ai-search-identity.bicep' = if (isWorkshop) {
...
module existingOpenAiProject '../identity/foundry-role-assignment.bicep' = if (!empty(azureExistingAIProjectResourceId) && isWorkshop) {
