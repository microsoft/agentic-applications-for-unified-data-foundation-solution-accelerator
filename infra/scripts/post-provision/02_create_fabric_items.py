...
if CREATE_FABRIC_WORKSPACE:
    FABRIC_CAPACITY_ID = os.getenv("AZURE_FABRIC_CAPACITY_RESOURCE_ID")
    if not FABRIC_CAPACITY_ID:
        print("ERROR: AZURE_FABRIC_CAPACITY_RESOURCE_ID not set. Deploy with createFabricWorkspace=true first.")
        sys.exit(1)
